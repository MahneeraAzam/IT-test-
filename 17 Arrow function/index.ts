...
// let function = (length: number, width: number): => number{
...
// let function greet (name:string, greeting:string = "Hello") => {
...
// let function friend (...MyNames: string[]): string[] => {
